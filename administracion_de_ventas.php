...
if ((isset($_SESSION['ventas'])&&$_SESSION['ventas']==TRUE)||isset($_SESSION['admin'])&&$_SESSION['admin']==TRUE) {
		...
		<body style="overflow-x: hidden;">
            ...
            <div class="row">
                <div class="col s12 destacados-titulo-wrapper center">
                    ...
                    <h4 class="destacados-titulo">Administración de ventas</h4>
                </div>
            </div>
            <?php
                    ...
                    ?>
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <label for="myInputb">Buscar por código</label>
                            </div>
                        </div>
                    <?php
                }
