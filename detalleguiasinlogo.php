  		...
  		<body style="overflow-x: hidden;" id="body">
            ...
            <div class="row">
                <div class="col s12 destacados-titulo-wrapper">
                    <a class="btn btn-media-accion waves-effect waves-light" href="historial_guias_pend.php"><i class="material-icons left">keyboard_arrow_left</i>Volver a la administración de Guias</a>
                </div>
            </div>
            <div class="row">
                <div class="col s12 destacados-titulo-wrapper center">
                    <i class="material-icons small">assignment</i>
                    <h4 class="destacados-titulo">Datos Remitente de Guia sin Logo</h4>
                </div>
            </div>
            <div class="row">
                <div class="col s12 destacados-wrapper">
                    <?php
                        ...
                        $guiadetalle->verGuiaSL($facturanum);
                    ?>
                </div>
            </div>
    		<?php
