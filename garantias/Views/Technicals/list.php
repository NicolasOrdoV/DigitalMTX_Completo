                                    ...
                                    <tbody>
                                        <?php foreach ($technicals as $key => $technical) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $technical->DescripcionP." ".$technical->idDetalle?></td>
                                                <td>
                                                    <div class="row clearfix">
                                                        <?php if ($technical->EstadoG == "Tramite" || $technical->EstadoG == "Pendiente por servicio tecnico") { ?>
                                                            <div class="col-sm-6">
                                                                <a href='?controller=technical&method=details&id=<?php echo $technical->idDetalle.'&name='.$technical->DescripcionP ?>' class="btn btn-info"><i class="material-icons">add</i></a>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                </td>
