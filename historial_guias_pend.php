...
if ((isset($_SESSION['ventas'])&&$_SESSION['ventas']==TRUE)||isset($_SESSION['admin'])&&$_SESSION['admin']==TRUE ||isset($_SESSION['guia'])&&$_SESSION['guia']==TRUE ||isset($_SESSION['historial'])&&$_SESSION['historial']==TRUE) {
