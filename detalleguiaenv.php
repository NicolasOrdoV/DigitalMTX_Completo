  		...
  		<body style="overflow-x: hidden;" id="body">
            ...
            <div class="row">
                <div class="col s12 destacados-titulo-wrapper">
                    <a class="btn btn-media-accion waves-effect waves-light" href="historial_guias.php"><i class="material-icons left">keyboard_arrow_left</i>Volver a la administración de Guias</a>
                </div>
            </div>
            <div class="row">
