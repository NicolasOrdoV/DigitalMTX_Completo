...
<html>
      ...
      ?>
      <meta charset="utf-8">
    	<title>Digital MTX | Outlet</title>
            ...
            <div class="row">
                <div class="row">
                    <div class="col s12 destacados-titulo-wrapper">
                        <h4 class="sucursales-titulo center">Outlet</h4>
                    </div>
                </div>
                        ...
                        <form action="" method="GET" class="col s12">
                            ...
                            <div class="col s12 m2 center" style="margin-top: -11px;">
                                <?php
                                    if (isset($_GET['filtrar']) || isset($_GET['categoria']) || !empty($_GET['like']) || !empty($_GET['tags'])) {
                                        ?>
                                            <a href="outlet.php" class="btn btn-eliminar-filtro center waves-effect waves-light tooltipped" data-position="bottom" data-tooltip="Quitar filtros"><i class="material-icons">delete</i></a>
                                        <?php
                                    }
                                ?>
                ...
                <div class="col s12 productos-wrapper">
                    <?php
                        if(isset($_GET['filtrar']) || isset($_GET['categoria'])) {
                            ...
                            $qryadd="SELECT * FROM dtm_productos WHERE `outlet` = 1";
