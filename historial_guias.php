...
if ((isset($_SESSION['ventas'])&&$_SESSION['ventas']==TRUE)||isset($_SESSION['admin'])&&$_SESSION['admin']==TRUE||(isset($_SESSION['historial'])&&$_SESSION['historial']==TRUE)) {
		...
		<body style="overflow-x: hidden;">
            ...
            <div class="row">
                <div class="col s12 destacados-titulo-wrapper center">
                    ...
                    <h4 class="destacados-titulo">Historial de Guias Enviados</h4>
                </div>
            </div>
                        <div class="row">
