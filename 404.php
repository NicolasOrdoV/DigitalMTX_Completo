...
<html>
    <head>
        ...
        ?>
        <meta charset="utf-8">
        <title>Digital MTX | Página no encontrada</title>
  	...
  	<body style="overflow-x: hidden;">
        ...
        <div class="row">
            <div class="col s12 destacados-titulo-wrapper center">
                <h4 class="destacados-titulo">Error: 404 - Página no encontrada</h4>
            </div>
        </div>
        <div class="row no-margin">
            <div class="row">
                <div class="col s12 sucursales-wrapper center">
                    Lo sentimos pero la página a la que usted intentó acceder no existe.
                </div>
            </div>
            <div class="row no-margin">
                <div class="col s12 sucursales-wrapper center">
                    <a href="index.php" class="btn btn-media-accion waves-effect waves-light"><i class="material-icons left">home</i>Ir a la página principal</a>
                </div>
            </div>
        </div>
        <?php
